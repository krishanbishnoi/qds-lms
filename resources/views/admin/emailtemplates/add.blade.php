                        ...
                        <div class="form-group <?php echo $errors->first('constants') ? 'has-error' : ''; ?>">
                            <table class="table  table-responsive">
                                <tr>
                                    <td colspan="2">
                                        {!! Html::decode(
                                            Form::label('constants', trans('Constants') . '<span class="requireRed"> * </span>', ['class' => 'mws-form-label']),
                                        ) !!}
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        {{ Form::select('constants', [], '', ['empty' => 'Select one', 'class' => 'form-control', 'id' => 'constants']) }}
                                        <div class="error-message help-inline">
                                    ...
                                    <td>
                                        <a onclick = "return InsertHtml()" href="javascript:void(0)"
                                            class="btn  btn-success no-ajax pull-right"><i
