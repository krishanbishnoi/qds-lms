...
<div class="content-wrapper">
    <div class="page-header">
        <h2 class="page-title">Add Email Template</h2>
            ...
            <div class="card">
                ...
                {{ Form::open(['role' => 'form','url' => '/admin/email-manager/add-template','class' => 'mws-form']) }}
					...
					<div class="form-group <?php echo ($errors->first('body')?'has-error':''); ?>">
						{!! Html::decode( Form::label('body',trans("Email Body").'<span class="requireRed"> * </span>', ['class' => 'mws-form-label'])) !!}
						<div class="mws-form-item">
					...
					<div class="mws-button-row">
						...
						<a href="{{URL::to('/admin/email-manager/add-template')}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('Reset')  }}</a>
