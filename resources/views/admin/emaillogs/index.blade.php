...
@section('content')
    ...
    <div aria-hidden="false" aria-labelledby="myModalLabel" role="dialog" tabindex="-1" id="getting_basic_list_popover"
            ...
            <div class="box-body">
                ...
                <div class="col-md-2 col-sm-2">
                    <div class="form-group ">
                        {!! Html::decode(
                            Form::label('email_to', trans('Email To') . '<span class="requireRed">  </span>', ['class' => 'mws-form-label']),
                        ) !!}
                        {{ Form::text('email_to', isset($email_to) ? Request::get('email_to') : '', [
                            'class' => 'form-control',
                            'id' => 'country',
                            'placeholder' => 'Email',
                        ]) }}
                ...
                <div class="col-md-2 col-sm-2">
                    <div class="form-group ">
                        ...
                        {{ Form::text('subject', isset($subject) ? $subject : '', [
                            'class' => 'form-control',
                            'id' => 'country',
                            'placeholder' => 'Subject',
                        ]) }}
                ...
                <div class="col-md-2 col-sm-2">
                    <div class="form-group ">
                        {!! Html::decode(
                            Form::label('keyword', trans('Keyword') . '<span class="requireRed">  </span>', ['class' => 'mws-form-label']),
                        ) !!}
                        {{ Form::text('keyword', isset($keyword) ? $keyword : '', [
                            'class' => 'form-control',
                            'id' => 'country',
                            'placeholder' => 'Keyword',
                        ]) }}
                ...
                <div class="col-md-4 col-sm-4 padding">
                    <div class="d-flex">
                        <button class="btn btn-primary mr-2 px-4"><i class='fa fa-search '></i>
                            {{ trans('Search') }}</button>
                        <a href="{{ URL::to('/admin/email-logs') }}" class="btn btn-primary"><i class="fa fa-refresh "></i>
                                        ...
                                        <tr class="items-inner">
                                            ...
                                            <td class="action-td" data-th="{{ trans('Action') }}">
                                                <a href='javascript:void(0);' class="btn btn-info"
                                                    title='{{ trans('View') }}'
                                                    onclick="getPopupClient({{ $data->id }})"> <i
                                                        class="fa fa-eye"></i>
                                                </a>
                                            </td>
                                        </tr>
