...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                {{ Form::open(['role' => 'form', 'url' => 'admin/faqs-manager/edit-faqs/' .$faq->id, 'class' => 'mws-form']) }}
                            ...
                            <div class="form-group <?php echo $errors->first('answer') ? 'has-error' : ''; ?>">
                                ...
                                <div class="mws-form-item">
                                    {{ Form::textarea('answer', $faq->answer, ['class' => 'form-control textarea_resize', 'id' => 'answer', 'rows' => 3, 'cols' => 3]) }}
                        ...
                        <input type="submit" value="{{ trans('Save') }}" class="btn btn-danger">
							<a href="{{URL::to('admin/faqs-manager/add-faqs')}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('Reset')  }}</a>
