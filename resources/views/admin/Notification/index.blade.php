                    ...
                    <table class="table table-hover table-striped">
                        ...
                        <tbody id="powerwidgets">
                            ...
                            <tr class="items-inner">
                                ...
                                <td data-th='{{ trans("Description") }}'>{{strip_tags(wordwrap(Str::limit( $record->description, 150),25,"<br>\n")) }}</td>
                                ...
                                <td data-th='{{ trans("Action") }}'>
                                    <a title="Edit" href="{{URL::to('admin/notification-template/edit-notification-template/'.$record->id)}}" class="btn btn-primary"><span class="fas fa-edit"></span></a>

                                    <a  title="Delete"href="{{URL::to('admin/notification-template/delete-notification/'.$record->id)}}" data-delete="delete"  class="delete_any_item btn btn-danger" title="Delete" data-confirm = 'Are you sure?' ><span class="fas fa-trash-alt   "></span></a>
