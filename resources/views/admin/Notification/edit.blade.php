...
<div class="content-wrapper">
	...
	<div class="row">
		<div class="col-md-12 grid-margin stretch-card">
			<div class="card">
				<div class="card-body">
                	{{ Form::open(['role' => 'form','url' => 'admin/notification-template/edit-notification-template/'.$Notification->id,'class' => 'mws-form']) }}
					<div class="mws-panel-body no-padding tab-content">
						...
						<div class="form-group <?php echo ($errors->first('title')) ? 'has-error' : ''; ?>">
							...
							<div class="mws-form-item">
								{{ Form::text('title',$Notification->title, ['class' => 'form-control']) }}
								<div class="error-message help-inline">
						...
						<div class="form-group <?php echo ($errors->first('en_name')?'has-error':''); ?>">
							<div class="mws-form-row">
								...
								<div class="mws-form-item">
									{{ Form::text('name',$Notification->name, ['class' => 'form-control']) }}
									<div class="error-message help-inline">
										<?php echo $errors->first('name'); ?>
									</div>
								</div>
						...
						<div class="form-group <?php echo $errors->first('description') ? 'has-error' : ''; ?>">
							...
							<div class="mws-form-item">
								{{ Form::textarea("description",$Notification->description, ['class' => 'form-control textarea_resize','id' => 'description' ,"rows"=>3,"cols"=>3]) }}
						...
						<div class="mws-button-row">
							...
							<a href='{{ route("$modelName.edit",$Notification->id)}}' class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('Reset')  }}</a>
