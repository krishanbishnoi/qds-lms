            ...
            <div class="card">
                ...
                {{ Form::open(['role' => 'form','url' =>  route("$modelName.edit",$model->id),'class' => 'mws-form', 'files' => true,"autocomplete"=>"off"]) }}
					<div class="mws-panel-body no-padding tab-content">
						<div class=" form-group <?php echo ($errors->first('domain')?'has-error':''); ?>">
							<div class="mws-form-row">
							{!! Html::decode( Form::label('domain', trans("Domain").'<span class="requireRed">* </span>', ['class' => 'mws-form-label'])) !!}
								<div class="mws-form-item">
									{{ Form::text('domain',$model->domain,  ['class' => 'form-control','maxlength'=>"250"]) }}
									<div class="error-message help-inline">
										<?php echo $errors->first('domain'); ?>
									</div>
								</div>
							</div>
						</div>
