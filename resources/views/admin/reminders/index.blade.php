                                    ...
                                    <tbody>
                                        @foreach ($reminders as $reminder)
                                            <tr>
                                                ...
                                                <td>
                                                    <span
                                                        class="badge @if ($reminder->entity_type === 'training') badge-info @else badge-warning @endif">
                                                ...
                                                <td>
                                                    ...
                                                    @if ($reminder->days_offset !== null)
                                                        <small class="text-muted">({{ $reminder->days_offset }}
                                                            days)</small>
                                                    @endif
                                                </td>
                                                <td>
                                                ...
                                                <td>
                                                    <form action="{{ route('Reminders.toggleStatus', $reminder->id) }}"
                                                        method="POST" style="display: inline;">
                                                        @csrf
                                                        <button type="submit"
                                                            class="btn btn-sm @if ($reminder->enabled) btn-success @else btn-secondary @endif">
                                                ...
                                                <td>
                                                    <div class="" role="group">
                                                        ...
                                                        <form action="{{ route('Reminders.sendTest', $reminder->id) }}"
                                                            method="POST" style="display: inline;">
                                                            @csrf
                                                        ...
                                                        <a href='{{ route('Reminders.destroy', "$reminder->id") }}'
                                                        ...
                                                        {{-- <form action="{{ route('Reminders.destroy', $reminder->id) }}"
                                                            ...
                                                            @method('DELETE')
                                                            <button type="submit"
                                                                class="btn btn-sm btn-danger delete_any_item"
                                                                title="Delete">
