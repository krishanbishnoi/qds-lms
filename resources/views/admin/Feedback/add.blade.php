                        ...
                        <div class="mws-panel-body no-padding tab-content">
                            <div class=" form-group <?php echo $errors->first('category_id') ? 'has-error' : ''; ?>">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        {{ Form::select('category_id', $TestCategory, '', ['class' => 'form-control', 'placeholder' => 'Please select test category']) }}
                            ...
                            <div class=" form-group <?php echo $errors->first('type') ? 'has-error' : ''; ?>">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        {{ Form::select('type', test_type, 'feedback_test', ['class' => 'form-control', 'placeholder' => 'Please select test type']) }}
                                        <div class="error-message help-inline">
			            ...
			            @endIf --}}
                            <div class="form-group <?php echo $errors->first('lob') ? 'has-error' : ''; ?>">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        {{ Form::select('lob', $lob, '', ['class' => 'form-control ', 'placeholder' => 'Please Select LOB']) }}
                                        <div class="error-message help-inline">
                            ...
                            <div class="form-group <?php echo $errors->first('region') ? 'has-error' : ''; ?>">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        {{ Form::select('region', $region, '', ['class' => 'form-control ', 'placeholder' => 'Please Select Region']) }}
                                        <div class="error-message help-inline">
                            ...
                            <div class="form-group <?php echo $errors->first('circle') ? 'has-error' : ''; ?>">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        {{ Form::select('circle', $circle, '', ['class' => 'form-control ', 'placeholder' => 'Please Select Circle']) }}
                                        <div class="error-message help-inline">
                            ...
                            <div class="form-group <?php echo $errors->first('number_of_questions') ? 'has-error' : ''; ?>">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        {{ Form::text('number_of_questions', '', ['class' => 'form-control small', 'id' => 'number_of_questions', 'maxlength' => '10', 'oninput' => "this.value=this.value.replace(/[^0-9]/g,'');"]) }}
                                        <div class="error-message help-inline">
                            ...
                            <div class="form-group <?php echo $errors->first('time_of_test') ? 'has-error' : ''; ?>">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        {{ Form::text('time_of_test', '', ['class' => 'form-control small', 'id' => 'time_of_test', 'maxlength' => '10', 'oninput' => "this.value=this.value.replace(/[^0-9]/g,'');"]) }}
                                        <div class="error-message help-inline">
                            ...
                            <div class="form-group <?php echo $errors->first('publish_result') ? 'has-error' : ''; ?>">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        <input class="form-check-input" type="radio" name="publish_result" id="0"
                                            value="0" checked>
                                        <label class="form-check-label" for="0">yes</label>
                                        <input class="form-check-input" type="radio" name="publish_result" id="1"
                                            value="1">
                            ...
                            <div class="form-group <?php echo $errors->first('thumbnail') ? 'has-error' : ''; ?>">
                                <div class="mws-form-row">
                                    ...
                                    <div class="mws-form-item">
                                        {{ Form::file('thumbnail', ['class' => '', 'accept' => 'image/*']) }}
                                        <div class="error-message help-inline">
