                                            ...
                                            <div class="mws-form-item">
                                                <div style="display: flex; align-items: center; gap: 20px;">
                                                    ...
                                                    <div style="display: flex; align-items: center; gap: 5px;">
                                                        <input class="form-check-input mt-0" type="radio" name="skip"
                                                            id="skip_no" value="0"
                                                            {{ isset($model) && $model->skip == 0 ? 'checked' : '' }}>
                                                        <label class="form-check-label mb-0" for="skip_no">Yes</label>
                                                    </div>
                                                    ...
                                                    <div style="display: flex; align-items: center; gap: 5px;">
                                                        ...
                                                        <label class="form-check-label mb-0" for="skip_yes">No</label>
                                                    </div>
