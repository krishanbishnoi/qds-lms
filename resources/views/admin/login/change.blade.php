        ...
        @endif
          {{-- <h6 class="font-weight-light">Sign in to continue.</h6> --}}
            ...
            <div class="form-group">
              ...
              <div class="form-group">
                {!! Form::input('password', 'password_confirmation','', ['class' => 'form-control form-control-lg','placeholder' => 'confirm password']) !!}
              </div>

            <div class="mt-3">
              <button type="submit" class="btn btn-block btn-gradient-primary btn-lg font-weight-medium auth-form-btn" name="admin-login">Reset Password</button>
            </div>
