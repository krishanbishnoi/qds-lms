        ...
        <div class="box-body">
            ...
            <div class="col-md-4 col-sm-4 ">
                ...
                <div class="d-flex">
                    ...
                    <a href='{{ route("$modelName.index",$test_id)}}' class="btn btn-primary"> <i class="fa fa-refresh "></i> {{ trans('Clear Search') }}</a>
                </div>
            </div>
            {{ Form::close() }}
        </div>
            ...
            <div class="box-body mb-2">
                ...
                <form action="{{ route('import.questions',$test_id) }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="d-md-flex justify-content-between align-items-center gap-3">
                        <a class="btn btn-primary mt-2" href="{{ route('download.sample.file.questions') }}"> Download sample file</a>
                ...
                <div class="card-body">
                    <div class="box-header with-border pd-custom">
                        <div class="listing-btns">
                            ...
                            <a href='{{route("$modelName.add",$test_id)}}' class="btn btn-success btn-small pull-right mb-2"> {{ trans("Add New ") }}{{ $sectionNameSingular }} </a>
                        </div>
                    </div>
                            ...
                            <tr class="items-inner">
                                ...
                                <td data-th='' class="action-td">
                                    <!-- @if($result->is_active == 1)
										...
										@endif  -->
                                    <a href='{{route("$modelName.edit",[$test_id,$result->id])}}' class="btn btn-primary" title="Edit"> <span class="fas fa-edit"></span></a>
                                    ...
                                    <a href='{{route("$modelName.view",[$test_id,$result->id])}}' class="btn btn-success" title="View"> <span class="fas fa-eye"></span></a>
