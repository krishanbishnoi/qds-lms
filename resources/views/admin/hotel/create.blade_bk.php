                ...
                <div class="first-step">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                ...
                                <select class="js-example-basic-multiple" name="amenity_common[]" multiple="multiple"
                                    id="amenity">
                    ...
                    <div class="col-md-12 append-amenty">
                        <div class="row roomRow">
                            ...
                            <div class="removeRoom"><i class="fa fa-times" aria-hidden="true"></i></div>
                            <div class="col-sm-4">
                                <div class="form-group ">
                            ...
                            <div class="col-sm-4">
                                <div class="form-group {{ $errors->has('name') ? 'has-error' : '' }}">
                                    ...
                                    <i class="fa fa-info-circle info-icon" data-toggle="tooltip" data-placement="right"
                                        title="Add new amenities from amenities section" aria-hidden="true"></i></label>
                                    <select class="js-example-basic-multiple" name="hotel[1][amenity][]"
                                        multiple="multiple">
                                        @if (!empty($Amenity))
                            ...
                            <div class="col-sm-4">
                                <div class="form-group ">
                                    ...
                                    <select class="js-example-basic-multiple" name="hotel[1][bed_type][]"
                                        multiple="multiple">
                                        @if (!empty($bedtype))
