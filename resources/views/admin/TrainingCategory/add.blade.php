        ...
        <div class="page-header">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="{{ route('TrainingCategory.index') }}">{{ $sectionName }}</a></li>
            ...
            <div class="col-md-12 grid-margin stretch-card">
                <div class="card">
                    <div class="card-body">
                        ...
                        @if ($flag == 1)
                            {{ Form::model($model, ['url' => route('TrainingCategory.add'), 'class' => 'mws-form', 'files' => true, 'autocomplete' => 'off']) }}
                            {{ Form::hidden('id', null) }}
                        @else
                            {{ Form::open(['role' => 'form', 'route' => 'TrainingCategory.add', 'class' => 'mws-form', 'files' => true, 'autocomplete' => 'off']) }}
                        @endif
                        ...
                        <div class="mws-panel-body no-padding tab-content">
                            ...
                            <div class="mws-button-row">
                                ...
                                <a href="{{ route('TrainingCategory.add') }}" class="btn btn-primary reset_form"><i
                                        class=\"icon-refresh\"></i> {{ trans('Clear') }}</a>
                                <a href="{{ route('TrainingCategory.index') }}" class="btn btn-info"><i
