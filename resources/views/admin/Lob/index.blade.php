            ...
            <div class="box-body">
                ...
                <div class="col-md-2 col-sm-2">
                    <div class="form-group ">
                        ...
                        {{ Form::text('lob', isset($searchVariable['lob']) ? $searchVariable['lob'] : '', ['class' => 'form-control', 'placeholder' => 'Category']) }}
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        {{ link_to_route(
                                            ...
                                            [
                                                'sortBy' => 'lob',
                                                'order' => $sortBy == 'lob' && $order == 'desc' ? 'asc' : 'desc',
                                                $query_string,
                                            ],
                                            [
                                                'class' =>
                                                    $sortBy == 'lob' && $order == 'desc'
                                                        ? 'sorting desc'
                                                        : ($sortBy == 'lob' && $order == 'asc'
                                                            ? 'sorting asc'
                                                            : 'sorting'),
                                            ],
                                        ) }}
