                ...
                <div class="row">
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('from_email') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="name" name="from_email" class="form-control" value="{{ old('name', isset($company) ? $company->name : '') }}" required>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('subject') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="name" name="subject" class="form-control" value="{{ old('name', isset($company) ? $company->name : '') }}" required>
                                </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group {{ $errors->has('reply_mail') ? 'has-error' : '' }}">
                                ...
                                <input type="text" id="name" name="reply_mail" class="form-control" value="{{ old('name', isset($company) ? $company->name : '') }}" required>
                                </div>
                        ...
                        <div class="col-md-12">
                            <div class="form-group {{ $errors->has('content') ? 'has-error' : '' }}">
                                ...
                                <textarea class="myCkeditor form-control"  name="content" value="" rows="12"></textarea>
