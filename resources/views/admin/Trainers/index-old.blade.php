...
<div class="content-wrapper">
    ...
    <div class="box search-panel collapsed-box">
        <div class="box-body">
            ...
            <div class="col-md-2 col-sm-2">
                <div class="form-group ">
                    {!! Html::decode(Form::label('fullname', trans('Full Name') . '<span class="requireRed">
                    </span>', ['class' => 'mws-form-label'])) !!}
                    {{ Form::text('fullname', isset($searchVariable['fullname']) ? $searchVariable['fullname'] : '', ['class' => ' form-control', 'placeholder' => 'Full Name']) }}
                </div>
            </div>
            <div class="col-md-2 col-sm-2">
                <div class="form-group ">
    ...
    <!-- <div class="box search-panel collapsed-box">
        <div class="box-body mb-4">
                <form action="{{ route('import.trainers') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <a class="btn btn-primary" onclick="downloadFile()"> Download sample file</a>

                    <a class="btn btn-success" href="{{ route('export.trainers') }}">Export Trainers</a>
                </div>
        ...
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    {{-- <a class="btn btn-success" href="{{ route('export.trainers') }}">Download Trainers</a>
...
//     });
        ...
        function downloadFile() {
            var fileUrl = '{{ asset('sample-files/trainer-sample-file.xlsx') }}';
            var link = document.createElement('a');
            link.href = fileUrl;
            link.download = 'trainer-sample-file.xlsx';
