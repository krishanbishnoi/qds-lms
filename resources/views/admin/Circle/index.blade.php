            ...
            <div class="box-body">
                ...
                <div class="col-md-2 col-sm-2">
                    <div class="form-group ">
                        ...
                        {{ Form::text('circle', isset($searchVariable['circle']) ? $searchVariable['circle'] : '', ['class' => 'form-control', 'placeholder' => 'Circle']) }}
                    </div>
                </div>
                                ...
                                <tr>
                                    ...
                                    <th>
                                        {{ link_to_route(
                                            ...
                                            [
                                                'sortBy' => 'circle',
                                                'order' => $sortBy == 'circle' && $order == 'desc' ? 'asc' : 'desc',
                                                $query_string,
                                            ],
                                            [
                                                'class' =>
                                                    $sortBy == 'circle' && $order == 'desc'
                                                        ? 'sorting desc'
                                                        : ($sortBy == 'circle' && $order == 'asc'
                                                            ? 'sorting asc'
                                                            : 'sorting'),
                                            ],
                                        ) }}
                                    ...
                                    <th>
                                        {{ link_to_route(
                                            ...
                                            [
                                                'sortBy' => 'region_id',
                                                'order' => $sortBy == 'region_id' && $order == 'desc' ? 'asc' : 'desc',
                                                $query_string,
                                            ],
                                            [
                                                'class' =>
                                                    $sortBy == 'region_id' && $order == 'desc'
                                                        ? 'sorting desc'
                                                        : ($sortBy == 'region_id' && $order == 'asc'
                                                            ? 'sorting asc'
                                                            : 'sorting'),
                                            ],
                                        ) }}
                                ...
                                @if (!$results->isEmpty())
                                    ...
                                    @foreach ($results as $record)
                                        <tr class="items-inner">
                                            <td>{{ $sn++ }}</td>
                                            <td data-th='{{ trans('Page Name') }}'>{{ $record->circle }}</td>
                                            <td data-th='{{ trans('Page Name') }}'>{{ $record->region_id }}</td>
                                            <td> <span
