...
<div class="content-wrapper">
    <div class="page-header">
        @can('mail_create')
        <a class="btn btn-gradient-primary btn-fw" href="{{ route("admin.tags.create") }}"> {{ trans('global.add') }} Tags</a>
        @endcan
                        ...
                        <tr data-entry-id="{{ $tag->id }}">
                            ...
                            <td>
                                <div class="actionBtnGroup">
                                    @can('hotel_show')
                                        {{-- <a class="btn btn-xs btn-primary" href="{{ route('admin.mails.show', $tag->id) }}">
