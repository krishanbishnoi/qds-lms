                            ...
                            <div class="col-md-6">
                                <div class="form-group <?php echo $errors->first('type') ? 'has-error' : ''; ?>">
                                    <div class="mws-form-row">
                                        ...
                                        <div class="mws-form-item">
                                            {{ Form::select('type', $TrainingType, null, ['class' => 'form-control', 'placeholder' => 'Please select training type']) }}
                                            <div class="error-message help-inline">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="mws-button-row">
                                    ...
                                    <a href="{{ route('Training.add') }}" class="btn btn-primary reset_form"><i
                                            class=\"icon-refresh\"></i> {{ trans('Clear') }}</a>
                                    <a href="{{ route('Training.index') }}" class="btn btn-info"><i
