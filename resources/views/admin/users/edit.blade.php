        ...
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="form-group <?php echo ($errors->first('employee_id')?'has-error':''); ?>">
                        <div class="mws-form-row">
                            ...
                            <div class="mws-form-item">
                                {{ Form::text('employee_id',$model->employee_id, ['class' => 'form-control small']) }}
                    ...
                    {{-- <div class="form-group <?php echo ($errors->first('olms_id')?'has-error':''); ?>">
                        <div class="mws-form-row">
                            {!! Html::decode( Form::label('olms_id', trans("Employee Id").'<span class="requireRed">
                                * </span>', ['class' => 'mws-form-label'])) !!}
                            <div class="mws-form-item">
                                {{ Form::text('olms_id',$model->olms_id, ['class' => 'form-control small','readonly'=>'readonly']) }}
                                <div class="error-message help-inline">
                                    <?php echo $errors->first('olms_id'); ?>
                                </div>
                            </div>
                        </div>
                    </div> --}}
                    ...
                    <div class="form-group <?php echo ($errors->first('designation')?'has-error':''); ?>">
                        <div class="mws-form-row">
                            {!! Html::decode( Form::label('designation', trans("Designation").'<span class="requireRed"> * </span>',
                            ['class' => 'mws-form-label'])) !!}
                            <div class="mws-form-item">
                                {{ Form::select('designation',$designation,$model->designation, ['class' => 'form-control ','placeholder' => 'Please Select Designation ']) }}
                                <div class="error-message help-inline">
                    ...
                    <div class="form-group <?php echo ($errors->first('gender')?'has-error':''); ?>">
                        <div class="mws-form-row">
                            {!! Html::decode( Form::label('gender', trans("Gender").'<span class="requireRed"> *
                            </span>', ['class' => 'mws-form-label'])) !!}
                            <div class="mws-form-item">
                                <input type="radio" name="gender" value="male" id="gender_male" {{ $model->gender == 'male' ? 'checked' : '' }}>
                                <label for="gender_male">Male</label>

                                <input type="radio" name="gender" value="female" id="gender_female" {{ $model->gender == 'female' ? 'checked' : '' }}>
                    ...
                    <div class="form-group <?php echo ($errors->first('allow_create_training') ? 'has-error' : ''); ?>">
                            <div class="mws-form-row">
                                {!! Html::decode(Form::label('allow_create_training', trans("Allow Create Training").'<span class="requireRed"> * </span>', ['class' => 'mws-form-label'])) !!}
                                <div class="mws-form-item">
                                    {{ Form::checkbox('allow_create_training', '1', $model->allow_create_training == 1, ['class' => '']) }}
                                    <div class="error-message help-inline">
                        ...
                        <div class="form-group <?php echo ($errors->first('allow_create_test') ? 'has-error' : ''); ?>">
                            <div class="mws-form-row">
                                {!! Html::decode(Form::label('allow_create_test', trans("Allow Create Test").'<span class="requireRed"> * </span>', ['class' => 'mws-form-label'])) !!}
                                <div class="mws-form-item">
                                    {{ Form::checkbox('allow_create_test', '1', $model->allow_create_training  == 1, ['class' => '']) }}
                                    <div class="error-message help-inline">
