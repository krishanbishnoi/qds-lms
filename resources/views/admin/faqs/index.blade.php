...
<div class="content-wrapper">
    <div class="page-header">
        @can('mail_create')
        <a class="btn btn-gradient-primary btn-fw" href="{{ route("admin.faqs.create") }}"> {{ trans('global.add') }} Faqs</a>
        @endcan
    ...
    <div class="row">
      ...
      <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
          <div class="card-body">
            <h4 class="card-title"> Faq {{ trans('global.list') }}</h4>
                        ...
                        <tr data-entry-id="{{ $faq->id }}">
                            ...
                            <td>
                                <div class="actionBtnGroup">
                                    @can('hotel_show')
                                        {{-- <a class="btn btn-xs btn-primary" href="{{ route('admin.mails.show', $faq->id) }}">
