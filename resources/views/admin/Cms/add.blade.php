...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                    {{ Form::open(['role' => 'form','url' => 'admin/cms-manager/add-cms','files' => true,'class' => 'mws-form']) }}
						...
						<div class="mws-button-row">
							...
							<a href="{{URL::to('admin/cms-manager/add-cms')}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('Reset')  }}</a>
