                    ...
                    <div class="mws-panel-body no-padding tab-content">
                                        ...
                                        <tr>
                                            <td width="700px">
                                                <div
                                                    ...
                                                    {!! Html::decode( Form::label('option', trans("Option").'<span
                                                        class="requireRed"> </span>', ['class' => 'mws-form-label']))
                                                    !!}
                                                    <div class="mws-form-item">
											...
											<td style=" padding-top: 20px;" width="25px">
                                                <div class="form-group">
                                                    <input type="hidden" name="data[<?php echo $i;?>][entryID]"
                                                        id="entryID_<?php echo $i;?>" value="{{$question->id}}">
                                                    <?php if($i !=1){?>
                        ...
                        <div class="form-group <?php echo ($errors->first('marks')?'has-error':''); ?>">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item">
                                    {{ Form::text('marks',$model->marks, ['class' => 'form-control small','id'=>'marks']) }}
                                    <div class="error-message help-inline">
                        ...
                        {{-- <div class="form-group <?php echo ($errors->first('time_limit')?'has-error':''); ?>">
                            <div class="mws-form-row">
                                {!! Html::decode( Form::label('time_limit', trans("Time Limit").'<span
                                    class="requireRed"> * </span>', ['class' => 'mws-form-label'])) !!}
                                <div class="mws-form-item">
                    ...
                    bootbox.confirm("Are you sure want to remove this?",
                        function(result) {
                            if (result) {
                                ...
                                $.ajax({
                                    url: '{{ URL("trainer/questions/delete-more-option") }}',
                                    type: 'post',
                                    data: {
                                        'id': entID
                                    },
