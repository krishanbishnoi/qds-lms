...
<section class="content-header">
	<h1 class="text-center">Bank Details
		<!-- <span class="pull-right">
			<a href="{{URL::to('trainer/change-password')}}" class="btn btn-danger"><i class=\"icon-refresh\"></i>Change Password</a>
		</span> -->
	</h1>
...
<section class="content">
    <div class="box">
		<div class="box-body">
			<div class="row">
				<div class="col-md-6">
				{{ Form::open(['role' => 'form','url' => 'trainer/bankdetail','class' => 'mws-form','files'=>'true']) }}
					...
					<div class="mws-button-row">
						...
						<a href="{{URL::to('trainer/bankdetail')}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('Reset')  }}</a> 
					</div>
				{{ Form::close() }}
				</div>
			</div> 
