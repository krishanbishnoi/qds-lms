...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-12 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
				{{ Form::open(['role' => 'form','url' => 'trainer/myaccount','class' => 'mws-form','files'=>'true']) }}
					...
					<div class="mws-button-row">
						...
						<a href="{{URL::to('trainer/myaccount')}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('Reset')  }}</a>
					</div>
				{{ Form::close() }}
                </div>
            </div>
