                ...
                <ul class="navbar-nav navbar-nav-right">
                    <li class="nav-item nav-profile dropdown">
                        ...
                        <div class="dropdown-menu navbar-dropdown" aria-labelledby="profileDropdown">
                            <a class="dropdown-item" href="{{ URL('trainer/myaccount')}}">
                                <i class="mdi  me-2 text-success"></i> Profile </a>
                            <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ URL('trainer/change-password')}}">
                                <i class="mdi  me-2 text-primary"></i> Change Password </a>
                            <div class="dropdown-divider"></div>
                                <a class="dropdown-item" href="{{ URL('trainer/logout')}}">
            ...
            <nav class="sidebar sidebar-offcanvas" id="sidebar">
                <ul class="nav">
                    ...
                    <li class="nav-item <?php echo request()->segment(2) === 'users' ? 'active' : ''; ?>">
                        <a class="nav-link" href="{{ route('TrainerTrainees.index')}}">
                            <span class="menu-title" >Users Management</span>
                            <i class="mdi mdi-account menu-icon"></i>
                        </a>
                    </li>
                    {{-- <li class="nav-item <?php echo request()->segment(2) === 'tests' ? 'active' : ''; ?>">
                        <a class="nav-link" href="{{ route('TrainerTest.index')}}">
                    ...
                    <li class="nav-item tests <?php echo request()->segment(2) === 'tests' ? 'active' : ''; ?>">
                        ...
                        <div class="collapse <?php echo request()->segment(2) === 'tests' ? 'show' : ''; ?>" id="testManagement">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('TrainerTestCategory.index') }}">Tests Categories</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('TrainerTest.index')}}">Tests</a>
                                </li>
                            </ul>
                        </div>
                    </li>
                    {{-- <li class="nav-item <?php echo request()->segment(2) === 'trainings' ? 'active' : ''; ?>">
                        <a class="nav-link" href="{{ route('TrainerTraining.index')}}">
                            <span class="menu-title" >Training Management</span>
                            <i class="mdi mdi-account menu-icon"></i>
                        </a>
                    </li> --}}
                    <li class="nav-item trainings  <?php echo request()->segment(2) === 'trainings' ? 'active' : ''; ?>">
                        <a class="nav-link" data-bs-toggle="collapse" href="#trainingManagement" aria-expanded="false"
                            aria-controls="ui-basic-training">
                        ...
                        <div class="collapse <?php echo request()->segment(2) === 'trainings' ? 'show' : ''; ?>" id="trainingManagement">
                            <ul class="nav flex-column sub-menu">
                                <li class="nav-item">
                                    <a class="nav-link" href="{{ route('TrainerTrainingCategory.index') }}">
