                    ...
                    <div class="mws-panel-body no-padding tab-content">
                        <div class=" form-group <?php echo ($errors->first('category_id')?'has-error':''); ?>">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item">
                                    {{ Form::select('category_id',$trainingCategory,$model->category_id, ['class' => 'form-control','placeholder' => 'Please select training category']) }}
                        ...
                        <div class=" form-group <?php echo ($errors->first('type')?'has-error':''); ?>">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item">
                                    {{ Form::select('type',$TrainingType,$model->type,  ['class' => 'form-control','placeholder' => 'Please select training type']) }}
                                    <div class="error-message help-inline">
                        ...
                        <div class="form-group <?php echo ($errors->first('number_of_attempts')?'has-error':''); ?>">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item">
                                <input class="form-check-input" type="radio" name="skip" id="0" value="0" {{ $model->skip == '0' ? 'checked' : '' }}>
                                    <label class="form-check-label" for="0">
                                        yes
                                    </label>
                                    <input class="form-check-input" type="radio" name="skip" id="1" value="1" {{ $model->skip == '1' ? 'checked' : '' }}>
                    ...
                    bootbox.confirm("Are you sure want to remove this?",
                        function(result) {
                            if (result) {
                                ...
                                $.ajax({
                                    url: '{{ URL("admin/trainings/delete-more-document") }}',
                                    type: 'post',
                                    data: {
                                        'id': entID
                                    },
