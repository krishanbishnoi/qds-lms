						...
						<tbody>
							<tr>
								...
								<td data-th='Name' class="txtFntSze">
									{{ isset($model->first_name) ? $model->first_name : '' }}
								</td>
							</tr>
							<tr>
								<th width="30%" class="text-right txtFntSze">Last Name</th>
								<td data-th='Name' class="txtFntSze">
									{{ isset($model->last_name) ? $model->last_name : '' }}
								</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td data-th='Category Name' class="txtFntSze">{{ $model->username }}</td>
							</tr>
							<tr>
							...
							<tr>
								...
								<td data-th='Category Name' class="txtFntSze">{{ $model->bio }}</td>
							</tr>
							<tr>
