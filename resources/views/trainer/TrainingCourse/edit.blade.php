                    ...
                    <div class="mws-panel-body no-padding tab-content">
                        ...
                        <div class="form-group <?php echo ($errors->first('test_id') ? 'has-error' : ''); ?>">
                            <div class="mws-form-row">
                                ...
                                <div class="mws-form-item">
                                    {{ Form::select('test_id',$test,$model->test_id, ['class' => 'form-control ']) }}
                                    <div class="error-message help-inline">
                        ...
                        {!! Html::decode( Form::label('training_documents', trans("Training Documents").'<span
                            class="requireRed"> * </span>', ['class' => 'mws-form-label'])) !!}
                                    ...
                                    <tr>
                                        ...
                                        <td width="700px">
                                            <div
                                                ...
                                                {!! Html::decode( Form::label('document', trans("Document").'<span
                                                    class="requireRed"> </span>', ['class' => 'mws-form-label']))
                                                !!}
                                                <div class="mws-form-item">
                                        ...
                                        <td width="700px">
                                            <div
                                                class="form-group <?php echo ($errors->first('length')) ? 'has-error' : ''; ?>">
                                                {!! Html::decode( Form::label('length', trans("Length").'<span
                                                    class="requireRed"> </span>', ['class' => 'mws-form-label']))
                                                !!}
                                                <div class="mws-form-item">
                                                            ...
                                                            @if ($document->type == 'image')
                                                                @if (config('TRAINING_DOCUMENT_URL') . $document->document != '')
                                                                    ...
                                                                    <img height="100%" width="100%"
                                                                        src="{{ config('TRAINING_DOCUMENT_URL') . $document->document }}" />
                                                                @endif
                                        ...
                                        <td style=" padding-top: 20px;" width="25px">
                                            <div class="form-group">
                                                <input type="hidden" name="data[<?php echo $i; ?>][entryID]"
                                                    id="entryID_<?php echo $i; ?>" value="{{$document->id}}">
                                                <?php if ($i != 1) {?>
