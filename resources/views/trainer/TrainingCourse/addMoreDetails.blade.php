		...
		<tr>
			...
			<td width="700px">
				<div class="form-group <?php echo ($errors->first('document')) ? 'has-error' : ''; ?>">
					{!! Html::decode( Form::label('document', trans("Document").'<span class="requireRed">  </span>', ['class' => 'mws-form-label'])) !!}
					<div class="mws-form-item">
            ...
            <td width="700px">
				<div class="form-group <?php echo ($errors->first('length')) ? 'has-error' : ''; ?>">
					{!! Html::decode( Form::label('length', trans("Length").'<span class="requireRed">  </span>', ['class' => 'mws-form-label'])) !!}
					<div class="mws-form-item">
