        ...
        {{ Form::open(['method' => 'get','role' => 'form','route' => "$modelName.index",'class' => 'row mws-form']) }}
			...
			<div class="col-md-2 col-sm-2">
				<div class="form-group ">
					...
					{{ Form::text('type',((isset($searchVariable['type'])) ? $searchVariable['type'] : ''), ['class' => 'form-control' , 'placeholder' => 'Training Type']) }}
				</div>
			</div>
                                    ...
                                    @foreach ($results as $record)
                                        <tr class="items-inner">
                                            ...
                                            <td data-th='' class="action-td">
												...
												@endif  --}}
												<a href='{{route("$modelName.edit","$record->id")}}' class="btn btn-primary" title="Edit"> <span class="fas fa-edit"></span></a>
