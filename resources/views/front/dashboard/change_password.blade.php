...
<div class="content-wrapper">
    ...
    <div class="row">
        <div class="col-md-6 grid-margin stretch-card">
            <div class="card">
                <div class="card-body">
                {{ Form::open(['role' => 'form','url' => '/changed-password','class' => 'mws-form','id'=>'change_password_form','files'=>'true']) }}
				...
				<div class="mws-button-row">
					...
					<a href="{{URL::to('/change-password')}}" class="btn btn-primary"><i class=\"icon-refresh\"></i> {{ trans('Reset')  }}</a>
				</div>	
				{{ Form::close() }}
                </div>
            </div>
