        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                        ...
                        <div style="max-height: 60vh; overflow-y: auto;" id="instructionContent">
                            <div class="mb-3">
                                <ul class="list-group list-group-flush mb-3">
                                    ...
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">❓</span>
                                        <span><strong>Total Questions:</strong>
                                            {{ count($trainingQuestions) }}</span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">✅</span>
                                        <span><strong>Passing Score:</strong>
                                            {{ $trainingTest->minimum_marks }}%</span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">🧾</span>
                                        <span><strong>Question Types:</strong> The test consists of MCQs
                                            (Multiple
                                            Choice
                                    ...
                                    <li class="list-group-item d-flex align-items-start">
                                        ...
                                        <span><strong>All Questions Are Mandatory:</strong> You must answer
                                            every
                                            question
                                    ...
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">➕</span>
                                        <span><strong>No Negative Marking:</strong> There is no penalty for
                                            incorrect
                                            answers, so attempt all questions confidently.</span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">🌐</span>
                                        <span><strong>Stable Internet Required:</strong> Any network
                                            disconnection may
                                            automatically submit your test and log the activity.</span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">🧭</span>
                                        <span><strong>Stay on Test Page:</strong> Switching to another tab or
                                            minimizing
                                            the
                                            browser will trigger warnings. Multiple violations will auto-submit
                                            your
                                            test.</span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">🚫</span>
                                        <span><strong>Do Not Refresh:</strong> Reloading, pressing F5, or
                                            clicking the
                                            back
                                    ...
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">🎥</span>
                                        <span><strong>Webcam Must Stay On:</strong> Your webcam must detect your
                                            face
                                            during
                                    ...
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">🎤</span>
                                        <span><strong>Mic Access May Be Monitored:</strong> Your microphone may
                                            be used
                                            to
                                    ...
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">📵</span>
                                        <span><strong>No Mobile Devices:</strong> Using your phone,
                                            smartwatches, or
                                            other
                                    ...
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">🧠</span>
                                        <span><strong>No External Help:</strong> This is an individual
                                            assessment.
                                            Collaboration or help from others will result in
                                    ...
                                    <li class="list-group-item d-flex align-items-start">
                                        ...
                                        <span><strong>AI Surveillance Active:</strong> Face, tab, and activity
                                            monitoring
                                            tools are in use to ensure test integrity. Every action is
                                            logged.</span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">🔍</span>
                                        <span><strong>Copy/Paste Disabled:</strong> Right-click, inspect
                                            element, or
                                            using
                                    ...
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">👁️</span>
                                        <span><strong>System Focus Monitoring:</strong> Unusual mouse movements
                                            or
                                            inactivity may be flagged as suspicious.</span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">📝</span>
                                        <span><strong>Time-Managed Questions:</strong> Allocate your time
                                            wisely. Some
                                            questions may be time-bound within the test.</span>
                                    </li>
                                    <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">⚠️</span>
                                        <span><strong>Zero Tolerance Policy:</strong> Any attempt to bypass
                                            restrictions
                                            will result in immediate test submission and logging of the
                                            attempt.</span>
                                    </li>
                                    {{-- <li class="list-group-item d-flex align-items-start">
                                        <span class="me-2">🔁</span>
                            ...
                            <div class="text-center mt-3">
                                <p class="text-danger fw-bold">
                                    🚨 You are being monitored. Any kind of malpractice will lead to
                                    auto-submission,
                                    disqualification, and improper behavior will result in automatic test
                                    termination.
                                </p>
                            </div>
                        </div>
                ...
                <div class="modal-footer">
                    <button type="button" id="startTestBtn" class="btn btn-success" disabled>✅ I’ve Read &
                        Start
                        Test</button>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="test-summary">
                                    <div class="summary-item">
                                        ...
                                        <div class="summary-value">{{ $trainingTest->time_of_test }} minutes
                                        </div>
                                    </div>
                                    <div class="summary-item">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <p><strong>Questions Answered:</strong> <span
                                                id="answered-count">0</span>/{{ count($trainingQuestions) }}
                                        </p>
                                    </div>
                                    <div class="col-md-6">
