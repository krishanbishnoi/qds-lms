...
return [
    ...
    'WEBSITE_IMG_URL' => url('/images/') . '/',
    'WEBSITE_UPLOADS_ROOT_PATH' => base_path('public' . DIRECTORY_SEPARATOR),
    'WEBSITE_UPLOADS_URL' => url('/') . '/',

    'WEBSITE_FRONT_UPLOADS_URL' => url('/slider_images/') . '/',

    'WEBSITE_ADMIN_URL' => url('/admin/') . '/',
    'WEBSITE_ADMIN_IMG_URL' => url('/admin/img/') . '/',
    'WEBSITE_ADMIN_JS_URL' => url('/admin/js/') . '/',
    'WEBSITE_ADMIN_FONT_URL' => url('/admin/fonts/') . '/',
    'WEBSITE_ADMIN_CSS_URL' => url('/admin/css/') . '/',

    'SETTING_FILE_PATH' => app_path('settings.php'),

    'CK_EDITOR_URL' => url('/ck_editor_images/') . '/',
    'CK_EDITOR_ROOT_PATH' => base_path('public/ck_editor_images/') . '/',

    'USER_IMAGE_URL' => url('/user_images/') . '/',
    'USER_IMAGE_ROOT_PATH' => base_path('public/user_images/') . '/',

    'TRAINING_DOCUMENT_URL' => url('/training_document/') . '/',
    'TRAINING_DOCUMENT_ROOT_PATH' => base_path('public/training_document/') . '/',

    'BATCH_REPORT_URL' => url('/batch_report/') . '/',
    'BATCH_REPORT_FILES' => base_path('public/batch_report/') . '/',

    'TEST_DOCUMENT_URL' => url('/test_document/') . '/',
    'TEST_DOCUMENT_ROOT_PATH' => base_path('public/test_document/') . '/',

    'CMS_IMAGE_URL' => url('/cms_images/') . '/',
    'CMS_IMAGE_ROOT_PATH' => base_path('public/cms_images/') . '/',

    'TEAM_MEMBERS_IMAGE_URL' => url('/team_members_images/') . '/',
    'TEAM_MEMBERS_IMAGE_ROOT_PATH' => base_path('public/team_members_images/') . '/',

    'BANNER_IMAGE_URL' => url('/banner_images/') . '/',
    ...
    'VISIBILITY' => [
        'all' => 'All',
        'only_airtelbank' => 'Only Airtel Bank',
    ],
    ...
    'question_type' => ['MCQ' => 'MCQ', 'SCQ' => 'SCQ', 'T/F' => 'T/F', 'FreeText' => 'FreeText (Subjective)'],
];
