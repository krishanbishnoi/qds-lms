    ...
    public function handle($request, Closure $next)
    {
        if (Auth::check()) {
            ...
            if ($user->session_id !== session()->getId()) {
                ...
                return redirect('/trainer')->with('error', 'Your session has expired due to a new login in another system or browser. Please log in again to continue.');
            }
        }
