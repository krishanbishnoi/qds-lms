...
class CoursesController extends BaseController
{
    ...
    public function index($training_id = 0)
    {
        ...
        // $DB->leftJoin('training_types', 'training_types.id', '=', 'courses.type')->leftJoin('trainings', 'trainings.id', '=', 'courses.training_id')->select('courses.*','training_types.type as type','trainings.title as training_id');
        ...
        return  View::make("trainer.$this->model.index", compact('results', 'searchVariable', 'sortBy', 'order', 'query_string', 'training_id'));
    }
    ...
    public function add($training_id = 0)
    {
        ...
        return  View::make("trainer.$this->model.add", compact('trainees', 'test', 'training_id'));
    } // end add()
    ...
    public function edit($training_id, $modelId)
    {
        ...
        return  View::make("trainer.$this->model.edit", compact('model', 'documents', 'test', 'training_id'));
    } // end edit()
    ...
    public function view($training_id, $modelId)
    {
        $training                =    Training::find($training_id);
        if (empty($training)) {
            return Redirect::route("TrainerTraining.index");
        }
        ...
        return  View::make("trainer.$this->model.view", compact('model', 'training_id', 'course_documents', 'training'));
    }
