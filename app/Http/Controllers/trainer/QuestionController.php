...
class QuestionController extends BaseController
{
    ...
    public function index($test_id = 0)
    {
        ...
        if ((Request::all())) {
            ...
            foreach ($searchData as $fieldName => $fieldValue) {
                if ($fieldValue != "") {
                    if ($fieldName == "title") {
                        $DB->where("questions.title", 'like', '%' . $fieldValue . '%');
                    }
        ...
        return  View::make("trainer.$this->model.index", compact('results', 'searchVariable', 'sortBy', 'order', 'query_string', 'test_id'));
    } // end index()
    ...
    public function add($test_id)
    {
        ...
        if (empty($model)) {
            return Redirect::route("TrainerTest.index");
        }


        return  View::make("trainer.$this->model.add", compact("test_id"));
    } // end add()
    ...
    public function view($test_id, $modelId)
    {
        ...
        return  View::make("trainer.$this->model.view", compact('model', 'test_id', 'attribute'));
    } // end edit()
    ...
    public function edit($test_id, $modelId)
    {
        ...
        return  View::make("trainer.$this->model.edit", compact('model', 'test_id', 'attribute'));
    } // end edit()
