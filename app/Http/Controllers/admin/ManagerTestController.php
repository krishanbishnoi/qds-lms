 ...
 */
class ManagerTestController extends BaseController
{
    public $model = 'ManagerTest';
    ...
    public function userTests()
    {
        ...
        return View::make("admin.$this->model.user-test-listing", compact('ongoing', 'upcoming', 'completedTests', 'cmpTest', 'testParticipantStatus', 'notifications', 'testResult'));
    }
    ...
    public function training_details_popup($id)
    {
        if (Request::ajax()) {
            ...
            return View::make('admin.Training.popup', compact('result'));
        }
    }
    ...
    public function userTestDetails($test_id = 0)
    {
        ...
        if ($testDetails) {
            ...
            return View::make("admin.$this->model.userTest", compact('test_id', 'testDetails', 'testQuestions', 'totalTrainees'));
        } else {
    ...
    public function userTestResult($id, Request $request)
    {
        ...
        if ($hasFreeTextQuestion) {
            return view('admin.ManagerTest.user-test-submit-freetext', [
                'testDetails' => $getTestMarks->title,
            ]);
        } else {
            return view('admin.ManagerTest.user-test-result', [
                'results'       => $results,
    ...
    public function userTestSubmittedThanksPage(Request $request)
    {
        ...
        return View::make("admin.$this->model.userTestSubmittedThanksPage", compact('testDetails', 'testAttendStatus'));
    }
    ...
    public function userTestCertificateDownload($id)
    {
        ...
        $pdf = PDF::loadView('admin.test.certificate-pdf', $data);
